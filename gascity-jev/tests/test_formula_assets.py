...
TOP_LEVEL_BUILD_FORMULA_PACKS = {
    "build-base": "gascity-jev",
    "build-basic": "gascity-jev",
...
class FormulaAssetTests(unittest.TestCase):
    ...
    def test_expected_role_agents_are_providerless(self) -> None:
        ...
        self.assertEqual(roles_pack["pack"]["name"], "gascity-jev-roles")
...
""".lstrip(),
        ...
        parent_show_json = """[
  {
    ...
    def test_methodology_code_review_expansions_are_report_mode_aware(self) -> None:
        ...
        context_prompt = (repo / "gascity-jev" / "assets" / "workflows" / "code-review-base" / "validate-context.md").read_text(
            encoding="utf-8"
        )
  ...
  },
  {
    ...
    def test_build_artifact_check_derives_rig_root_from_installed_script_when_env_is_unset(self) -> None:
        with tempfile.TemporaryDirectory() as td:
            ...
            worktree_validator = per_bead_worktree / "gascity-jev" / "assets" / "scripts" / validator.name
            ...
            for schema in (source_root / "schemas" / "build").glob("*.yaml"):
                destination = per_bead_worktree / "gascity-jev" / "schemas" / "build" / schema.name
