# Gas City Jev Build Requirements
...
| --- | --- |
| Status | Pilot |
| Scope | Inherited build contract and Jev additions for the experimental `gascity-jev` alternative |
...
with this variant. Historical experiments precede the split; see
[the pack README](README.md) for provenance and measured limitations.
...
| --- | --- |
| `gc.build.requirements.v1` | `gascity-jev/schemas/build/requirements.v1.yaml` |
| `gc.build.plan.v1` | `gascity-jev/schemas/build/plan.v1.yaml` |
| `gc.build.decomposition.v1` | `gascity-jev/schemas/build/decomposition.v1.yaml` |
| `gc.build.implementation-summary.v1` | `gascity-jev/schemas/build/implementation-summary.v1.yaml` |
| `gc.build.review.v1` | `gascity-jev/schemas/build/review.v1.yaml` |
| `gc.build.final-report.v1` | `gascity-jev/schemas/build/final-report.v1.yaml` |
...
Proof expectation: `gascity-jev/tests/test_formula_assets.py` compares
...
| GC-METH-012 | External implementation compatibility | Compound Engineering, Superpowers, BMAD, and gstack import the sibling `gascity` pack as `gc`, extend its `build-base`, replace raw subagent dispatch with Gas City formulas/fanouts, and preserve base artifact/mode contracts. | `compound-engineering/REQUIREMENTS.md`; `superpowers/REQUIREMENTS.md`; `bmad/REQUIREMENTS.md`; `gstack/REQUIREMENTS.md`; `tests/test_derived_pack_compatibility.py::DerivedPackCompatibilityTests`; `docs/design/build-methodology-framework-audit.md` |
...
- `python3 -m pytest gascity-jev/tests/test_derived_pack_compatibility.py -q`
- `python3 -m pytest -q`
- `gascity-jev/tests/test_formula_assets.py::FormulaAssetTests::test_base_formula_requirements_cover_formula_set`
- `gascity-jev/tests/test_formula_assets.py::FormulaAssetTests::test_build_base_is_full_lifecycle_virtual_contract`
- `gascity-jev/tests/test_formula_assets.py::FormulaAssetTests::test_third_party_build_packs_extend_base_and_vendor_sources`
- `gascity-jev/tests/test_derived_pack_compatibility.py::DerivedPackCompatibilityTests`
