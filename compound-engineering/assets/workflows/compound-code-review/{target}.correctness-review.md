Review implementation correctness with the installed Compound Engineering
correctness reviewer persona.

Check logic, edge cases, state transitions, error propagation, and intent-vs-implementation mismatches. Return structured findings for synthesis.
...
`<code-review-artifact-root>/correctness.md`. Record that exact path on the
