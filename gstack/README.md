...
justifies that gate. The former GraphV2 formulas and their pack-local agents
remain reachable in repository history but are absent from the active pack, so
Gas City cannot discover or route them.
