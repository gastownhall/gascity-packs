...
Examples:
  ...
  gc discord-intake post-message --channel-id 223456789012345678 --body-file ./message.txt
  gc discord-intake post-message --channel-id 223456789012345678 --thread-id 323456789012345678 --body "Update"
